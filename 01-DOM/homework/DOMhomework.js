...
let nombre = "Joel Almiron" //creamos el string

let spn = document.querySelector("#createdBy") //nos ubicamos en el ID

spn.innerHTML += " " + nombre //concatenamos el nombre
...
function buildToDo(todo, index) {
  // Tu código acá:
let toDoShell = document.createElement("div") //creamos un elemento en HTML

//! toDoShell.className //busca en elemento y crea una clase.
toDoShell.setAttribute("class","toDoShell")//busca el elemento y le crea un atributo (<div class = "toDoShell"> )
 let toDoText = document.createElement("span")//creamos un span

 toDoText.innerHTML = todo.description //<span>descriocion <span> 
toDoText.setAttribute("id",index)
//<span id=index >descriocion <span> 
...
toDoShell.appendChild(toDoText)//le estamos asociando el span en el div.
...
function displayToDos() {
  // Tu código acá:
  let toDoContainer = document.getElementById("#toDoContainer");//decidir donde voy a mostarlos
  toDoContainer.innerHTML = ""//lo iniciamos vacio 

  let result = buildToDos(toDoItems)//crear un array y recibo las tareas 
//result=[     se veria asi:
  //<div class = "toDoShell">
//<span id=index >descripcion <span>
// </div>,
//<div class = "toDoShell">
//<span id=index > Lista <span>
// </div>
//]

  result.map(elemento => toDoContainer.appendChild(elemento))
  //por cada elemento que tengo en el array , lo vamos anidar en el contenedor 
}
...
function addToDo() {
  // Tu código acá:
  let descripcion = document.getElementById("toDoImput").value;

  let tarea = new ToDo(descripcion)

  toDoItems.push(tarea)//extraemos el valor

  let inpt = document.getElementById("toDoImput")
  inpt.value = ""
...
function completeToDo(event) {
  ...
  // Tu código acá:
  toDoItems[index].completeToDo(event)
